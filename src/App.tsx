    ...
    <main id="top" className={staffRole ? 'staff-shell' : 'customer-shell'}>
      <header className="app-topbar">
        ...
        <div className="top-actions">
          ...
          <button className="locale-toggle" aria-label={locale === 'es' ? 'Switch to English' : 'Cambiar a español'} onClick={() => setLocale(locale === 'es' ? 'en' : 'es')} type="button">{locale === 'es' ? '🇬🇧' : '🇪🇸'}</button>
        </div>
      </header>
